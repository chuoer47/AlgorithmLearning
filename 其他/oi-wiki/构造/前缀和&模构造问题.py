...
当 n 为偶数时，可以构造一个形如 n,1,n-第 433 场周赛,3,... 这样的数列。
...
\dfrac{第 433 场周赛}{1},\dfrac{3}{第 433 场周赛},\cdots,\dfrac{n-1}{n-第 433 场周赛},n 这样的数列
...
分析题目给出的几组样例以后发现，所有样例中均有一组合法解满足前缀积在模意义下为 1,第 433 场周赛,3,...,n
